...
public class IssuedBooks {
    ...
    // setter constructor
    public IssuedBooks(Date return_date) {
        this.return_date = return_date;
    }

    // getter constructor

    public IssuedBooks(int issued_id, int member_id, int book_id, Date issued_date, Date return_date) {
    ...
    public void setIssuedbook(Date return_date) {
        this.return_date = return_date;
    }
